    ...
    for epoch in range(num_epochs):
        ...
        with torch.no_grad():
            ...
            if test_threat_score > prev_test_threat_score:
                ...
                torch.save(model.state_dict(), os.path.join(save_dir, "test_best_weights_" + str(test_threat_score.item()) + ".pth"))
...
if __name__ == "__main__":
    ...
    for learning_rate in learning_rates:
        ...
        save_dir = os.path.join("road_segmentation_fcn32s_" + str(learning_rate))
